    ...
    <div class="CartList" v-if="props.ifShow">
        ...
        <div class="Content">
            ...
            <div class="Detail">
                ...
                <div class="DetailBelow" v-for="(item, index) in cartList" :key="index">
                    <div class="DetailBelowName">
                        <div style="flex: 3;">
                    ...
                    <!-- <div style="flex: 1;" class="icon"><el-icon>
                            <Delete />
                        </el-icon>
                    </div> -->
...
for (let i = 0; i < cartList.length; i++) {
    totalPrice += Number(cartList[i].price.replace(' ETH', ''));
}
// 最后保留两位小数
